  ...
  Widget build(BuildContext context) {
    ...
    List<CategoryCardWidget> list = [
      const CategoryCardWidget(
          icon: Icon(Icons.flash_on_outlined), title: 'Flash Deal'),
      ...
      const CategoryCardWidget(
          icon: Icon(Icons.gif_box_outlined), title: 'Daily Gift'),
        ...
        line: [
          Text('Fashion',
              style: TextStyle(
                  ...
                  fontSize: 20,
                  fontWeight: FontWeight.bold)),
          Text('24 Brands', style: TextStyle(color: Colors.white, fontSize: 14))
        ],
    ...
    List<CardWidget> listProduct = [
      ...
      CardWidget(
        ...
        image: 'assets/images/Image_Popular_Product_3.png',
      ),
    ];
    return Scaffold(
        body: Column(
          ...
          () => Container(
            ...
            child: Row(
              ...
              children: [
                ...
                BalloonIconWidget(
                    icons: Icon(Icons.message_outlined,
